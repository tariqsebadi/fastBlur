...
- (void)viewDidLoad
{
  ...
  //[self setupWithImage:[UIImage imageNamed:@"ghost.png"]];
}
...
- (void)setupWithImage:(UIImage*)image {
  UIImage * fixedImage = [image imageWithFixedOrientation]; // [UIImageObject imagewfoMethodCallOnUIMGObj]
  self.workingImage = fixedImage;
  //self.mainImageView.image = fixedImage; //removed
  
  // Commence with processing!
  //[self logPixelsOfImage:fixedImage]; //removed
    [ImageProcessor sharedProcessor].delegate = self;  // what does this do?
